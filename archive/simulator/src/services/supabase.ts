  ...
  public: {
    Tables: {
      game_week_matchups: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_game_week_matchups_away_team"
          ...
          {
            foreignKeyName: "fk_game_week_matchups_game_week"
          ...
          {
            foreignKeyName: "fk_game_week_matchups_home_team"
    ...
    Functions: {
      get_individual_player_fantasy_scores: {
        Args:
          | { p_game_week_id: number; p_mode_name: string }
          | { p_game_week_id: number; p_mode_name: string; p_league_id: number }
          | {
